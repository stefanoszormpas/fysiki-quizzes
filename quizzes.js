const quiz_krouseis = [
  {
    ...
    options: ["Η κινητική ενέργεια", "Η μηχανική ενέργεια", "Η ορμή", "Η ταχύτητα του κάθε σώματος"],
    answer: 2
  },
  {
    question: "2. Σε απολύτως ελαστική κρούση διατηρούνται:",
    options: ["Μόνο η κινητική ενέργεια", "Η κινητική ενέργεια και η ορμή", "Η δυναμική ενέργεια", "Καμία από τις παραπάνω"],
    answer: 1
  },
  {
    question: "3. Η εξίσωση διατήρησης της ορμής είναι: \\( m_1 u_1 + m_2 u_2 = m_1 v_1 + m_2 v_2 \\). Τι εκφράζει;",
    options: ["Τη διατήρηση ενέργειας", "Τη μεταβολή της δύναμης", "Τη διατήρηση της ορμής", "Τη μεταβολή της ταχύτητας"],
    answer: 2
  },
  {
  ...
  },
  {
    ...
    options: ["Μηδέν", "Ίδια για τα δύο σώματα", "Μεγαλύτερη του ενός σώματος", "Αρνητική πάντα"],
    answer: 1
  },
  {
    question: "6. Πότε δύο σώματα μένουν ενωμένα μετά την κρούση;",
    options: ["Μόνο αν έχουν την ίδια ταχύτητα πριν", "Όταν η κρούση είναι ελαστική", "Όταν η κρούση είναι απολύτως πλαστική", "Όταν είναι ακίνητα"],
    answer: 2
  },
  {
    question: "7. Αν \\( p = mv \\), τότε η ορμή σώματος μάζας \\( 2\\,\\text{kg} \\) που κινείται με \\( 3\\,\\text{m/s} \\) είναι:",
    options: ["\\( 5\\,\\text{kg·m/s} \\)", "\\( 6\\,\\text{kg·m/s} \\)", "\\( 1.5\\,\\text{kg·m/s} \\)", "\\( 3\\,\\text{kg·m/s} \\)"],
    answer: 1
  },
  {
    ...
    options: ["\\( \\dfrac{u}{3} \\)", "\\( \\dfrac{2u}{3} \\)", "\\( \\dfrac{3u}{2} \\)", "\\( \\dfrac{u}{2} \\)"],
    answer: 0
  },
  {
    question: "9. Αν σε ελαστική κρούση \\( m_1 = m_2 \\) και \\( u_2 = 0 \\), τότε μετά την κρούση ισχύει:",
    options: ["\\( v_1 = 0,\\ v_2 = u_1 \\)", "\\( v_1 = u_1,\\ v_2 = 0 \\)", "\\( v_1 = v_2 \\)", "\\( v_1 = -u_1,\\ v_2 = u_2 \\)"],
    answer: 0
  },
  {
    question: "10. Αν σε πλαστική κρούση η αρχική κινητική ενέργεια είναι \\( K_{\\text{πριν}} \\) και η τελική \\( K_{\\text{μετά}} \\), τότε:",
    options: ["\\( K_{\\text{μετά}} = K_{\\text{πριν}} \\)", "\\( K_{\\text{μετά}} > K_{\\text{πριν}} \\)", "\\( K_{\\text{μετά}} < K_{\\text{πριν}} \\)", "\\( K_{\\text{μετά}} = 0 \\)"],
    answer: 2
  }
];
